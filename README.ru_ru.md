...
[WiKi page] (<https://github.com/ivli/roim/wiki/ROIM>) - содержит более подробное описание внутреннего устройства и вариантов использования Roim (увы пока только по Английски).
