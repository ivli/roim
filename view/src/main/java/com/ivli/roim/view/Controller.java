...
class Controller implements IController {                  
    ...
    abstract class BaseRoiCreator extends ActionItem {
        BaseRoiCreator(int aX, int aY) {
            super(aX, aY);
        }
    ...
    class RectangularRoiCreator extends BaseRoiCreator {
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (null != iAction) {
            ...
            addSelection(tmp);
            iAction = new BaseRoiCreator(e.getX(), e.getY()) {
                protected void DoAction(int aX, int aY) {
                    //iControlled.getROIMgr().moveObject(iSelected, aX-iX, aY-iY);
                    iControlled.getROIMgr().moveObject(iSelected, (aX-iX)/iControlled.getScale(), (aY-iY)/iControlled.getScale());
                    iControlled.repaint(); 
                }    
